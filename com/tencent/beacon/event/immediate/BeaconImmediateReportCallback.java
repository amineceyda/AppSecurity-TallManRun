...
public class BeaconImmediateReportCallback implements f<BeaconTransferResult> {
    ...
    private long f718d = new Date().getTime();
    ...
    private void a(com.tencent.beacon.base.net.d dVar) {
        ...
        g.e().a(dVar.b, dVar.f647d, dVar.f648e);
    ...
    public void onResponse(BeaconTransferResult beaconTransferResult) {
        ...
        try {
            ...
            com.tencent.beacon.base.net.b.d.a(this.f718d, responsePackageV2.serverTime, responsePackageV2.srcGatewayIp);
        } catch (Throwable th) {
            Throwable th2 = th;
            c.a(th2);
            a(new com.tencent.beacon.base.net.d(RequestType.LONG_CONNECTION.name(), "463", beaconTransferResult.getCode(), th2.getMessage(), th2));
        }
    }
}
