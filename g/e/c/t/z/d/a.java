...
public class a {
    ...
    public static java.util.Date b(java.lang.String r17, java.text.ParsePosition r18) throws java.text.ParseException {
        /*
            ...
            int r3 = r0 + 4
            int r0 = c(r1, r0, r3)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            r4 = 45
            boolean r5 = a(r1, r3, r4)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            if (r5 == 0) goto L_0x0018
            int r3 = r3 + 1
        L_0x0018:
            int r5 = r3 + 2
            int r3 = c(r1, r3, r5)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            boolean r6 = a(r1, r5, r4)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            if (r6 == 0) goto L_0x0026
            int r5 = r5 + 1
        L_0x0026:
            int r6 = r5 + 2
            int r5 = c(r1, r5, r6)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            r7 = 84
            boolean r7 = a(r1, r6, r7)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            r8 = 1
        ...
        L_0x0049:
            ...
            int r6 = r6 + 1
            int r7 = r6 + 2
            int r6 = c(r1, r6, r7)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            r12 = 58
            boolean r13 = a(r1, r7, r12)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            if (r13 == 0) goto L_0x0062
            int r7 = r7 + 1
        L_0x0062:
            int r13 = r7 + 2
            int r7 = c(r1, r7, r13)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            boolean r12 = a(r1, r13, r12)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
        ...
        L_0x0070:
            ...
            int r4 = r13 + 2
            int r12 = c(r1, r13, r4)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            r13 = 59
        ...
        L_0x0090:
            r13 = 46
            boolean r13 = a(r1, r4, r13)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
        ...
        L_0x00b6:
            ...
            int r15 = c(r1, r4, r14)     // Catch:{ IndexOutOfBoundsException -> 0x01d4, NumberFormatException -> 0x01d2, IllegalArgumentException -> 0x01d0 }
            int r14 = r14 - r4
        ...
        L_0x023a:
            goto L_0x0239
        */
        throw new UnsupportedOperationException("Method not decompiled: g.e.c.t.z.d.a.b(java.lang.String, java.text.ParsePosition):java.util.Date");
    }
    ...
    public static int c(String str, int i2, int i3) throws NumberFormatException {
        ...
        if (i2 < i3) {
            ...
            if (digit >= 0) {
                ...
                StringBuilder i6 = g.a.a.a.a.i("Invalid number: ");
                i6.append(str.substring(i2, i3));
                throw new NumberFormatException(i6.toString());
            }
        } else {
            i4 = 0;
            i5 = i2;
        ...
        while (i5 < i3) {
            ...
            if (digit2 >= 0) {
                ...
                StringBuilder i8 = g.a.a.a.a.i("Invalid number: ");
                i8.append(str.substring(i2, i3));
