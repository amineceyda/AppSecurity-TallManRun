...
public class s implements g0 {
    ...
    public static final k0 f5083e = new k0(10);

    /* renamed from: f  reason: collision with root package name */
    public static final k0 f5084f = new k0(1);

    /* renamed from: g  reason: collision with root package name */
    public static final k0 f5085g = new k0(24);
    public d0 b;
    public d0 c;
    ...
    public boolean equals(Object obj) {
        ...
        d0 d0Var5 = this.f5086d;
        d0 d0Var6 = sVar.f5086d;
    ...
    public void g(byte[] bArr, int i2, int i3) throws ZipException {
        ...
        while (i5 + 4 <= i4) {
            ...
            int i6 = i5 + 2;
            if (!k0Var.equals(f5084f)) {
                i5 = i6 + new k0(bArr, i6).c() + 2;
            } else if (i4 - i6 >= 26) {
                if (f5085g.equals(new k0(bArr, i6))) {
                    int i7 = i6 + 2;
                    this.b = new d0(bArr, i7);
                    int i8 = i7 + 8;
                    this.c = new d0(bArr, i8);
                    this.f5086d = new d0(bArr, i8 + 8);
                    return;
                }
                return;
            } else {
    ...
    public byte[] h() {
        ...
        System.arraycopy(f5084f.a(), 0, bArr, 4, 2);
        System.arraycopy(f5085g.a(), 0, bArr, 6, 2);
        System.arraycopy(this.b.a(), 0, bArr, 8, 8);
        System.arraycopy(this.c.a(), 0, bArr, 16, 8);
        System.arraycopy(this.f5086d.a(), 0, bArr, 24, 8);
        return bArr;
    }
