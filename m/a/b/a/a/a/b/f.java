...
public class f extends InputStream {
    ...
    public final e f5148j = new e(32768);
    ...
    public final void a() throws IOException {
        ...
        if (a == 1) {
            ...
            int i4 = this.f5142d == 4096 ? 6 : 7;
            int a2 = (int) this.c.a(i4);
            int c2 = this.f5147i.c(this.c);
            if (c2 != -1 || a2 > 0) {
                int i5 = (c2 << i4) | a2;
                int c3 = this.f5146h.c(this.c);
                if (c3 == 63) {
                    c3 = (int) (((long) c3) + this.c.a(8));
                }
                int i6 = c3 + this.f5144f;
                e eVar2 = this.f5148j;
                int i7 = eVar2.c - (i5 + 1);
                int i8 = i6 + i7;
                while (i7 < i8) {
    ...
    public final void b() throws IOException {
        if (this.c == null) {
            if (this.f5143e == 3) {
                this.f5145g = c.b(this.b, 256);
            }
            this.f5146h = c.b(this.b, 64);
            this.f5147i = c.b(this.b, 64);
            this.c = new d(this.b);
        }
    }
