...
public class i extends j {
    public Typeface a(Context context, c cVar, Resources resources, int i2) {
        try {
            ...
            while (true) {
                ...
                d dVar = dVarArr[i4];
                try {
                    Font.Builder weight = new Font.Builder(resources, dVar.f1287f).setWeight(dVar.b);
                    if (!dVar.c) {
                        i5 = 0;
                    }
                    Font build = weight.setSlant(i5).setTtcIndex(dVar.f1286e).setFontVariationSettings(dVar.f1285d).build();
                    if (builder == null) {
    ...
    public android.graphics.Typeface b(android.content.Context r11, android.os.CancellationSignal r12, e.e.g.l[] r13, int r14) {
        /*
            r10 = this;
        ...
        L_0x0009:
            ...
            android.net.Uri r7 = r6.a     // Catch:{ IOException -> 0x0054 }
        ...
        L_0x007f:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: e.e.d.i.b(android.content.Context, android.os.CancellationSignal, e.e.g.l[], int):android.graphics.Typeface");
    }
